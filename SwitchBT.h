 ...
 */
class SwitchBT : public BTHID, public SwitchParser {
public:
        /**
...
protected:
        ...
        virtual void sendOutputReport(SwitchOutput *output) { // Source: https://github.com/chrippa/ds4drv
                uint8_t buf[79];
